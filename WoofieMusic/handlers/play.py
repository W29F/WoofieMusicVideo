...
from WoofieMusic.helpers.gets import get_file_name, get_url
...
async def generate_cover(title, thumbnail):
    ...
    draw.text((205, 550), "Playing here...", (0, 0, 0), font=font)
    draw.text((205, 630), f"{title}", (0, 0, 0), font=font)
    img.save("final.png")
    os.remove("temp.png")
...
async def play(_, message: Message):
    ...
    if audio:
        ...
        try:
            ...
            thumb_name = f"thumb-{title}-WoofieMusicmusic.jpg"
