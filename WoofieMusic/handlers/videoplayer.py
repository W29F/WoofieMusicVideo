# Copyright (C) 2021 By WoofieMusicMusicProject
...
from config import BOT_USERNAME, BOT_NAME, UPDATES_CHANNEL, GROUP_SUPPORT, ASSISTANT_NAME, CHANNEL, API_ID, API_HASH
from WoofieMusic.helpers.decorators import authorized_users_only
from WoofieMusic.helpers.filters import command
from WoofieMusic.helpers.loggings import LOG
...
@Client.on_message(command(["cstop", f"cstop@{BOT_USERNAME}"]) & filters.group & ~filters.edited)
@authorized_users_only
